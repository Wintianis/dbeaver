...
public class GBase8sMetaModel extends GenericMetaModel {
    ...
    public GenericTableColumn createTableColumnImpl(@NotNull DBRProgressMonitor monitor,
        ...
        // Reset column size and scale for specific types
        if (isZeroScaleType(typeName)) {
            columnSize = 0;
            scale = null;
        }
        ...
        // Ignore default length for LVARCHAR, variable character types, and boolean types
        else if (isLvarcharWithDefaultColumnSize(typeName, columnSize)
                || isVariableCharacterWithDefaultColumnSize(typeName, columnSize) || isBooleanType(typeName)) {
            columnSize = 0;
        }
    ...
    private boolean isZeroScaleType(String typeName) {
        return GBase8sConstants.TYPE_BIGINT.equalsIgnoreCase(typeName)
                || GBase8sConstants.TYPE_BIGSERIAL.equalsIgnoreCase(typeName)
                || GBase8sConstants.TYPE_INT8.equalsIgnoreCase(typeName)
                || GBase8sConstants.TYPE_INTEGER.equalsIgnoreCase(typeName)
                || GBase8sConstants.TYPE_SERIAL.equalsIgnoreCase(typeName)
                || GBase8sConstants.TYPE_SERIAL8.equalsIgnoreCase(typeName)
                || GBase8sConstants.TYPE_SMALLFLOAT.equalsIgnoreCase(typeName)
                || GBase8sConstants.TYPE_SMALLINT.equalsIgnoreCase(typeName);
    }
    ...
    private boolean isBooleanType(String typeName) {
        return GBase8sConstants.TYPE_BOOLEAN.equalsIgnoreCase(typeName);
    }
